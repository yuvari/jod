...
const Reset_password_by_email_address = () =>{
    return(
        <div className="reset_password_by_email_address">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-2">
                        <img src="circle (2).png" width="200px" height="200px" className="circle2" />
                    </div>
                    <div className="col-8">
                                ...
                                <br />
                                    <br />
                                        <br />
                                            ...
                                            <h3><b>Reset Password by <br />Email Address!</b><br /></h3>
                                        </div>
                                        <div className="form-group div2">
                                    ...
                                    <hr />
                                        ...
                                        <div className="form-group div1">
                                        <label for="email" className="label1"><b>Email address</b></label><br />
